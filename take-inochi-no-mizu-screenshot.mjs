...
// inochi-no-mizu — landing view as a first-time visitor sees it.
const URL = 'https://kai-denrei.github.io/inochi-no-mizu/';
const OUT = 'screenshots/inochi-no-mizu.png';
const VW = 800, VH = 500;
