...
// creator-economy — landing view as a first-time visitor sees it.
const URL = 'https://kai-denrei.github.io/creator-economy/';
const OUT = 'screenshots/creator-economy.png';
const VW = 800, VH = 500;
