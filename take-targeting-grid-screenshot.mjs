...
// targeting-grid — landing view as a first-time visitor sees it.
const URL = 'https://kai-denrei.github.io/Targeting-grid/';
const OUT = 'screenshots/targeting-grid.png';
const VW = 800, VH = 500;
