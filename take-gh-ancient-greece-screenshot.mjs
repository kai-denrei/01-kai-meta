...
// gh-ancient-greece — landing view as a first-time visitor sees it.
const URL = 'https://kai-denrei.github.io/gh-ancient-greece/';
const OUT = 'screenshots/gh-ancient-greece.png';
const VW = 800, VH = 500;
