...
// wetwareviruses — landing view as a first-time visitor sees it.
const URL = 'https://kai-denrei.github.io/wetwareviruses/';
const OUT = 'screenshots/wetwareviruses.png';
const VW = 800, VH = 500;
