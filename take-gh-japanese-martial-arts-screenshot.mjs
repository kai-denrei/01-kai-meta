...
// gh-japanese-martial-arts — landing view as a first-time visitor sees it.
const URL = 'https://kai-denrei.github.io/gh-japanese-martial-arts/';
const OUT = 'screenshots/gh-japanese-martial-arts.png';
const VW = 800, VH = 500;
