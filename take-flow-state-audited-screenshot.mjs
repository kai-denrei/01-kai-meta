...
// flow-state-audited — landing view as a first-time visitor sees it.
const URL = 'https://kai-denrei.github.io/flow-state-audited/';
const OUT = 'screenshots/flow-state-audited.png';
const VW = 800, VH = 500;
