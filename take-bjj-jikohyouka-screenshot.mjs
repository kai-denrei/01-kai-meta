...
// bjj-jikohyouka — landing view as a first-time visitor sees it.
const URL = 'https://kai-denrei.github.io/bjj-jikohyouka/';
const OUT = 'screenshots/bjj-jikohyouka.png';
const VW = 800, VH = 500;
