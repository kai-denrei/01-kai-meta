...
// catapult-games — landing view as a first-time visitor sees it.
const URL = 'https://kai-denrei.github.io/catapult-games/';
const OUT = 'screenshots/catapult-games.png';
const VW = 800, VH = 500;
