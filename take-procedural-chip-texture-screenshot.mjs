...
// procedural-chip-texture — landing view as a first-time visitor sees it.
const URL = 'https://kai-denrei.github.io/procedural-chip-texture/';
const OUT = 'screenshots/procedural-chip-texture.png';
const VW = 800, VH = 500;
