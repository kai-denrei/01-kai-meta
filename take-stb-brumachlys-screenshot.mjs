...
// stb-brumachlys — landing view as a first-time visitor sees it.
const URL = 'https://kai-denrei.github.io/STB_Brumachlys/';
const OUT = 'screenshots/stb-brumachlys.png';
const VW = 800, VH = 500;
