...
// game-design-lessons — landing view as a first-time visitor sees it.
const URL = 'https://kai-denrei.github.io/game-design-lessons/';
const OUT = 'screenshots/game-design-lessons.png';
const VW = 800, VH = 500;
