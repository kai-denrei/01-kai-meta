...
// fiore-delli-liberi — landing view as a first-time visitor sees it.
const URL = 'https://kai-denrei.github.io/fiore-delli-liberi/GrapplingHistory/fiore/';
const OUT = 'screenshots/fiore-delli-liberi.png';
const VW = 800, VH = 500;
