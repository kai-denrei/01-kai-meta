...
// rvina-liminalis — landing view as a first-time visitor sees it.
const URL = 'https://kai-denrei.github.io/rvina-liminalis/';
const OUT = 'screenshots/rvina-liminalis.png';
const VW = 800, VH = 500;
