...
// ideogram4-scene-graph — landing view as a first-time visitor sees it.
const URL = 'https://kai-denrei.github.io/ideogram4-scene-graph/';
const OUT = 'screenshots/ideogram4-scene-graph.png';
const VW = 800, VH = 500;
